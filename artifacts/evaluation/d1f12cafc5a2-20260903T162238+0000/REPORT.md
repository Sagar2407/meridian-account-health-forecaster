...
Commit `d1f12cafc5a2` (working-tree state not determined), split **development**, provider **none (deterministic)**, generated 2026-09-03T16:22:38+00:00.

Thresholds `cbf44c84e4501881` (v2), dataset `absent`, model `logistic_regression` / `isotonic`, prompts `2b996f4bb4c449ae` (4).
...
| Path | Runs | p50 | p95 |
| --- | ---: | ---: | ---: |
| fast | 100 | 153.3000 ms | 238.2000 ms |
| tree_of_thought | 37 | 154.7000 ms | 219.1000 ms |
| abstained | 70 | 155.2000 ms | 225.2000 ms |
| blocked | 0 | not measured ms | not measured ms |
| **overall** | 207 | 154.2000 ms | 231.2000 ms |
...
At the frozen bands (green 0.8, amber 0.7, digest `cbf44c84e4501881`): **15 of 207 auto-released** (0.0725), 0 of them wrong.
