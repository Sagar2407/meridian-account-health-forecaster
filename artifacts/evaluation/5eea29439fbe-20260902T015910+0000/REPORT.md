...
Commit `5eea29439fbe` (working-tree state not determined), split **test**, provider **none (deterministic)**, generated 2026-09-02T01:59:10+00:00.
...
| Path | Runs | p50 | p95 |
| --- | ---: | ---: | ---: |
| fast | 22 | 159.0000 ms | 258.9000 ms |
| tree_of_thought | 15 | 152.6000 ms | 204.6000 ms |
| abstained | 16 | 152.5000 ms | 224.0000 ms |
| blocked | 0 | not measured ms | not measured ms |
| **overall** | 53 | 154.2000 ms | 230.7000 ms |
